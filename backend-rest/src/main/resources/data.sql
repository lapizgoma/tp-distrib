...
INSERT IGNORE INTO works (id, title, artist_id, image_url, creation_year, technique, dimensions, era, description, location, availability) VALUES
    (1,  'La noche estrellada', 1, 'https://placehold.co/600x400?text=La+noche+estrellada', 1889, 'OLEO', '73,7 x 92,1 cm', 'IMPRESIONISMO', 'Vista nocturna de un cielo ondulante sobre el pueblo de Saint-Rémy, pintada desde la ventana del sanatorio donde Van Gogh se encontraba internado; una de las obras más reconocidas del arte occidental.', 'SALA_4_ARTE_MODERNO', 'EN_EXHIBICION'),
    (2,  'Los girasoles', 1, 'https://placehold.co/600x400?text=Los+girasoles', 1888, 'OLEO', '92,1 x 73 cm', 'IMPRESIONISMO', 'Serie de bodegones con girasoles que Van Gogh pintó en Arlés para decorar la habitación de Gauguin; el amarillo domina la composición con una intensidad casi lumínica.', 'SALA_4_ARTE_MODERNO', 'EN_EXHIBICION'),
    (3,  'El dormitorio en Arlés', 1, 'https://placehold.co/600x400?text=El+dormitorio+en+Arles', 1888, 'OLEO', '72 x 90 cm', 'IMPRESIONISMO', 'Representación del dormitorio del artista en la Casa Amarilla, con perspectivas inclinadas y colores planos que transmiten una sensación de calma.', 'DEPOSITO', 'EN_DEPOSITO'),
    (4,  'Impresión, sol naciente', 2, 'https://placehold.co/600x400?text=Impresion+sol+naciente', 1872, 'OLEO', '48 x 63 cm', 'IMPRESIONISMO', 'Escena portuaria de Le Havre que dio nombre al movimiento impresionista; el sol naciente disuelve los contornos en pinceladas sueltas y luminosas.', 'SALA_2_IMPRESIONISMO', 'EN_EXHIBICION'),
    (5,  'Nenúfares', 2, 'https://placehold.co/600x400?text=Nenufares', 1906, 'OLEO', '89,9 x 94,1 cm', 'IMPRESIONISMO', 'Uno de los numerosos estudios que Monet realizó sobre el estanque de su jardín en Giverny, explorando los reflejos y la luz cambiante del agua.', 'SALA_2_IMPRESIONISMO', 'EN_EXHIBICION'),
    (6,  'La Mona Lisa', 3, 'https://placehold.co/600x400?text=La+Mona+Lisa', 1503, 'OLEO', '77 x 53 cm', 'RENACIMIENTO', 'Retrato de Lisa Gherardini, célebre por la técnica del sfumato y la enigmática sonrisa; probablemente la pintura más famosa del mundo.', 'SALA_1_GRANDES_MAESTROS', 'EN_EXHIBICION'),
    (7,  'La última cena', 3, 'https://placehold.co/600x400?text=La+ultima+cena', 1498, 'TEMPLE', '460 x 880 cm', 'RENACIMIENTO', 'Mural que representa la anunciación de la traición de Judas durante la última cena de Jesús, pintado en el refectorio de Santa Maria delle Grazie en Milán.', 'DEPOSITO', 'EN_DEPOSITO'),
    (8,  'Las dos Fridas', 4, 'https://placehold.co/600x400?text=Las+dos+Fridas', 1939, 'OLEO', '173,5 x 173 cm', 'VANGUARDIA', 'Doble autorretrato pintado tras su divorcio de Diego Rivera, donde las dos Fridas comparten el corazón y simbolizan sus dos raíces, mexicana y europea.', 'SALA_4_ARTE_MODERNO', 'EN_EXHIBICION'),
    (9,  'Autorretrato con collar de espinas', 4, 'https://placehold.co/600x400?text=Autorretrato+con+collar+de+espinas', 1940, 'OLEO', '63,5 x 49,5 cm', 'VANGUARDIA', 'Autorretrato donde la artista se muestra con un collar de espinas, acompañada por un colibrí y un gato; alude al sufrimiento y a la superación.', 'DEPOSITO', 'EN_DEPOSITO'),
    (10, 'Guernica', 5, 'https://placehold.co/600x400?text=Guernica', 1937, 'OLEO', '349,3 x 776,6 cm', 'VANGUARDIA', 'Monumental alegato contra la guerra inspirado en el bombardeo de la ciudad vasca de Guernica, con figuras desmembradas en blanco, negro y gris.', 'SALA_3_VANGUARDIAS', 'EN_EXHIBICION'),
    (11, 'El beso', 6, 'https://placehold.co/600x400?text=El+beso', 1908, 'OLEO', '180 x 180 cm', 'VANGUARDIA', 'Pareja abrazada cubierta por un manto dorado, obra cumbre del período dorado de Klimt y del modernismo vienés.', 'SALA_3_VANGUARDIAS', 'EN_EXHIBICION'),
    (12, 'La joven de la perla', 7, 'https://placehold.co/600x400?text=La+joven+de+la+perla', 1665, 'OLEO', '44,5 x 39 cm', 'BARROCO', 'Retrato de una joven con un turbante azul y una perla, conocido como la Mona Lisa del Norte por su mirada directa y su refinado tratamiento de la luz.', 'SALA_1_GRANDES_MAESTROS', 'EN_EXHIBICION'),
    (13, 'La persistencia de la memoria', 8, 'https://placehold.co/600x400?text=La+persistencia+de+la+memoria', 1931, 'OLEO', '24 x 33 cm', 'VANGUARDIA', 'Escena onírica de relojes derretidos sobre un paisaje costero, una de las imágenes más icónicas del surrealismo.', 'SALA_3_VANGUARDIAS', 'EN_EXHIBICION'),
    (14, 'Terraza de café por la noche', 1, 'https://placehold.co/600x400?text=Terraza+de+cafe+por+la+noche', 1888, 'OLEO', '80,7 x 65,3 cm', 'IMPRESIONISMO', 'Vista nocturna de una terraza en Arlés con colores intensos y contrastados, donde Van Gogh prescindió deliberadamente del uso del negro.', 'SALA_4_ARTE_MODERNO', 'EN_EXHIBICION'),
